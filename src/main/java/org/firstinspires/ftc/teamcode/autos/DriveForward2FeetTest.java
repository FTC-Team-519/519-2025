...
// Jonah was here
@Autonomous(name="Drive Forward 2 feet Test", group = "test")
public class DriveForward2FeetTest extends OpModeBase {
    ...
    public void init(){ 
        ...
        this.seq = new ParallelCommandGroup(new DriveForward(24, 1.0, robot), new AlignRotator(robot));
        this.seq.init();
    }
